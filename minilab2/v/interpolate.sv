module interpolate #(
  ...
  // Instantiate a shift register to delay the input data by one row
  // (ROW_LENGTH cycles).
  ...
  // Create a 2x2 sliding window of the input data. The current input data
  // and delayed row are the first column, and the second column is formed
  // by registering the first column one more cycle.
