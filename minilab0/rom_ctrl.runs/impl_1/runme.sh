...
HD_PWD='C:/Users/avery/ece554/minilabs/minilab0/rom_ctrl.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rom_ctrl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rom_ctrl.tcl -notrace
