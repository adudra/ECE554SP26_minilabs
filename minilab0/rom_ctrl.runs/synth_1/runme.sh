...
HD_PWD='C:/Users/avery/ece554/minilabs/minilab0/rom_ctrl.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rom_ctrl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rom_ctrl.tcl
