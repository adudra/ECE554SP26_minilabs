...
HD_PWD='C:/Users/avery/ece554/minilabs/minilab0/minlab0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log minlab0_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source minlab0_wrapper.tcl
