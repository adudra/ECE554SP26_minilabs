...
HD_PWD='C:/Users/avery/ece554/minilabs/minilab0/minlab0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log minlab0_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source minlab0_wrapper.tcl -notrace
