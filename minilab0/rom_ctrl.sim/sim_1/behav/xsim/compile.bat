...
REM
REM Generated by Vivado on Thu Jan 22 17:11:59 -0600 2026
...
echo "xvlog --incr --relax -L uvm -prj rom_ctrl_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj rom_ctrl_tb_vlog.prj -log xvlog.log
